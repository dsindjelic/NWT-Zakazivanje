...
namespace BankAccountSystem
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<BankAccountContext>(options =>options.UseSqlServer(Configuration["Data:BankAccoutSystem:ConnectionString"], b => b.MigrationsAssembly("BankAccountSystem")));
